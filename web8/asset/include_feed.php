<div class="feed-list-wrap">
	<h3 class="entry_header">
		ブログ<a class="show_all_entries" href="https://blog.kizukurinoie.jp" target="_blank">一覧を見る<i class="fa fa-angle-right"></i></a>
	</h3>
	<?php
	// 外部のフィードを記事中の最初の画像と表示する方法
	// 参考：http://2inc.org/blog/2012/07/15/1814/
	include_once( ABSPATH . WPINC . '/feed.php' );
	$rss = fetch_feed ( 'https://blog.kizukurinoie.jp/index.rdf' ); // 読み込むfeed
	if ( !is_wp_error( $rss ) ) {
	...
	<ul class="feed-list">
	    ...
	    <li class="feed-list-block">
	        <a href="<?php echo $item->get_permalink(); ?>" class="feed-list-item">
	            ...
	            <div class="feed-list-title"><?php echo $item->get_title(); ?></div>
	        </a>
	    </li>
	    <?php endforeach; ?>
	</ul>
